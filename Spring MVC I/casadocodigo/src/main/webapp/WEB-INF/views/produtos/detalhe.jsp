	...
	<article id="livro-css-eficiente">
		...
		<section class="buy-options clearfix">
			<form action='<c:url value="/carrinho/add" />' method="post" class="container">
				<ul id="variants" class="clearfix">
					<li class="buy-option"><input type="radio" name="id" class="variant-radio" id="product-variant-9720393823"
						value="9720393823" checked="checked" /> <label class="variant-label" for="product-variant-9720393823">
							E-book + Impresso </label> <small class="compare-at-price">R$ 39,90</small>
		...
		<div class="container">
			...
			<section class="data product-detail">
				...
				<p></p>
				<p>Data de publicação: </p><fmt:formatDate pattern="dd/MM/yyyy" value="${produto.dataLancamento.time}"/>
				<p>
